 ...
 */
export const illegalTypeErrorHandler: TypeHandler<IllegalTypeError, IllegalTypeErrorPlaceholder> = {
   ...
   */
  serialize(value: IllegalTypeError, _context: SerializerContext): IllegalTypeErrorPlaceholder {
    return {
      _erpc_type: 'illegal_type_error',
      name: value.name,
   ...
   */
  deserialize(placeholder: IllegalTypeErrorPlaceholder, _context: SerializerContext): IllegalTypeError {
