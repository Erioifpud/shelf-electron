...
import type { AskProcedure, DynamicProcedure, Procedure, TellProcedure } from "./procedure";
...
export type StubAskProcedure<TProc extends AskProcedure<any, any, any>> =
  (...args: InferPhantomData<TProc['input']>) => Promise<Awaited<InferPhantomData<TProc['output']>>>;
...
export type BuildStub<TApi> =
  ...
  TApi extends Procedure<any, any, any>
    ...
    : TApi extends Api<any, any>
      ...
      ? {
          [K in string & keyof TApi as TApi[K] extends Api<any, any> ? K : never]:
            TApi[K] extends Procedure<any, any, any>
